      ...
      <div>
        ...
        <div className="container"> <br></br>
          ...
          <div className="row">
            ...
            <div>
              <button className="btn btn-primary form-control form-input" id="btn-blue" onClick={() => this.handleAdd()}>Add New Member</button>
            </div>
          </div>
                ...
                return (
                  <tr key={index}>
                    ...
                    <td>
                      ...
                      <button className="btn btn-sm btn-danger m-1" id="blue" onClick={() => this.Drop(item.id_member)}>Hapus</button>
                    </td>
                  </tr>
                )
              })}
