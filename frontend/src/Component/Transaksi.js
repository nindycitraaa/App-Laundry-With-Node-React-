      ...
      <div>
        ...
        <div className="container"> <br></br>
            <h4 className="d-flex justify-content-between align-items-center mb-3">
                <span className="display-6">Transaksi Data</span>
                </h4><br></br>
          ...
          <div className="row">
            ...
            <div className="col-3 md-5">
                                {this.state.role == "admin" &&
                                    <NavLink to="/choosemember"> <button className="btn btn-primary form-control form-input" id="btn-blue">Add New Transaction</button></NavLink>
                ...
                return (
                  <tr key={index}>
                    ...
                    <td>{item.dibayar == "belum_bayar" &&
                                ...
                                <td>Rp. {item.total}</td>
                    <td>
                    <button className="btn btn-sm btn-danger m-1" id="blue" onClick={() => this.Drop(item.id_transaksi)}>Delete</button>
                    <button className="btn btn-sm btn-warning m-1" onClick={() => this.handleEdit(item)}>Edit</button>
